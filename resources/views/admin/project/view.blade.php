    ...
    <div class="container mb-5">
        <div class="row rounded" style="height: 56px; color: #344767; background: white;">
            ...
            <div class="col-md-12 mt-2">
                <span class="fs-4">All Project Items</span>
        ...
        <div class="row mt-5">
            <!--$data is called from the project model-->
                ...
                <div class="col-md-4 mt-5">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('edit.project',$_data->slug)}}" class="btn bg-gradient-info">Edit</a>
                            <a href="{{route('delete.project', $_data->id)}}" class="btn bg-gradient-danger" onclick="return confirm('This data will be deleted permanently')">Delete</a>
                        </div>
                    </div>
                </div>
            @endforeach
