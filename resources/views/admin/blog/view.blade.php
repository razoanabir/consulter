    ...
    <div class="container mb-5">
        <div class="row rounded" style="height: 56px; color: #344767; background: white;">
            ...
            <div class="col-md-12 mt-2">
                <span class="fs-4">All Blog Post Items</span>
        ...
        <!--all blog's information-->
        <div class="row mt-5">
            <!--$data is called from the blog model-->
                ...
                <div class="col-md-4 mt-5">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{Str::limit($_data->details, 100, '.....')}}</p>
                            <a href="{{route('edit.blog',$_data->slug)}}" class="btn bg-gradient-info">Edit</a>
                            <a href="{{route('delete.blog', $_data->id)}}" class="btn bg-gradient-danger" onclick="return confirm('This data will be deleted permanently')">Delete</a>
                        </div>
                    </div>
                </div>
            @endforeach
