...
<div class="container">
    ...
    <div class="card card-body mt-4 is-filled">
        <!--the form  is for store the information for blog page -->
        <form action="{{ route('store.blog') }}" method="post" enctype="multipart/form-data">
            ...
            <label for="title" class="form-label">Blog Post's Title</label>
            <input type="text" class="form-control" required name="title" id="title">

            <label for="image" class="form-label">Blog Post's Image</label>
            <input class="form-control form-control-lg" required name="image" id="image" type="file">

            <div class="form-group">
                <label for="details">Blog Post's Details</label>
                <textarea class="form-control" required name="details" id="details" rows="3"></textarea>
            </div>

            <!-- Experience -->
            <div class="form-group">
                <label for="personal_note">Author Thought/Note(Optional)</label>
                <textarea class="form-control" name="personal_note" id="personal_note" rows="3"></textarea>
            </div>
