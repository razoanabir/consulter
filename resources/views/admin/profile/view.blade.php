        ...
        <h5>Delete Account</h5>
            <div class="col-md-12 card p-4">
                    <div id="firstForm">
                        ...
                        <button id="showFormButton" class="btn bg-gradient-danger">Delete</button>
                    </div>
                    <div id="formContainer" style="display: none;">
                        <form action="{{route('delete_admin_data',Auth::guard('admin')->user()->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <button type="button" onclick="hideForm()" class="btn bg-gradient-primary">Cancel</button>
                            <button type="submit" onclick="confirm('Press Okey to delete the account permanently')"  class="btn bg-gradient-danger">Delete Account</button> 
                        </form>
                    </div>
            </div>
        </div>
