    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
        <div class="ms-md-auto pe-md-3 d-flex align-items-center ml-5">
            <div class="input-group form-search position-relative">
                ...
                <ul id="search-results" class="dropdown-menu dropdown-menu-end mt-5"
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
                <a href="javascript:;" class="nav-link text-white p-0" id="dropdownMenuButton"
                    ...
                    <div class="notification">
                        <img height="25px" src="https://img.icons8.com/?size=100&id=11668&format=png&color=FFFFFF" alt="">
                        @if(auth()->user()->unreadNotifications->count() > 0)
                        <span class="badge notification-badge">{{ auth()->user()->unreadNotifications->count() }}</span>
                        @endif
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                    <li>
                        <a href="{{ route('notifications.read.all') }}" class="dropdown-item text-center text-primary">
                            Mark All as Read
                        </a>
                    </li>
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item border-radius-md"
                            ...
                            <small>Follow Up Date: {{ $notification->data['follow_up_date'] }}</small>
                        </a>
                    </li>
                    @endforeach
                </ul>
                ...
                <a href="javascript:;" class="nav-link text-white p-0 " id="dropdownMenuButton"
                    ...
                    <div class="text-center">
                        <img height="30px" style="border-radius: 50%"
                            src="{{asset(Auth::guard('admin')->user()->image)}}" alt="img"><br>
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item border-radius-md" href="{{route('edit.profile')}}">
                            <div class="d-flex py-1">
                                <div class="my-auto">
                                    <img height="20px"
                                        src="https://img.icons8.com/?size=100&id=45193&format=png&color=000000" alt="">
                                    Edit Profile
                                </div>
                            </div>
                        </a>
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item border-radius-md" href="{{route('admin.logout')}}">
                            <div class="d-flex py-1">
                                <div class="my-auto">
                                    <img height="20px"
                                        src="https://img.icons8.com/?size=100&id=22112&format=png&color=000000" alt="">
                                    Log Out
                                </div>
                            </div>
                        </a>
